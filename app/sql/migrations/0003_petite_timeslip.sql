...
CREATE TYPE "public"."notification_type" AS ENUM('follow', 'praise', 'reply');--> statement-breakpoint
...
ALTER TABLE "praises" ALTER COLUMN "applause_id" SET NOT NULL;--> statement-breakpoint
ALTER TABLE "praises" ALTER COLUMN "profile_id" SET NOT NULL;--> statement-breakpoint
